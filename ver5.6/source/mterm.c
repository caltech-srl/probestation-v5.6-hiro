	   ...
	   if (ibinflg==0 && bufc >=32 && bufc <127) {
	      ...
	      if (idoneflg==1) {
	         ...
	         cmd1[4]='\0';
		      ...
		      sleep(1);
		      system("C:/cygwin64/home/spp1/work/ver5.6/mterm_end.sh");
		      //execl("C:\\cygwin64\\home\\spp1\\work\\ver5.6\\mterm_end.sh","mterm_end.sh"," ",0);
		      //execl("./mterm_end.sh","mterm_end.sh"," ",0);
		      //execlp("mterm_end.sh","mterm_end.sh"," ",0);
		 }
              }
